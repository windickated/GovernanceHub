const storyTitle = 'The Dischordian Saga: The Arrival - Episode 8';
const storyDuration = 'Duration: 7.6.2024 - 10.6.2024'
const storyText =
...
function addStory() {
  titleContainer.innerHTML = storyTitle;
  durationContainer.innerHTML = storyDuration;
  textContainer.innerHTML = storyText;
  let html = '';
